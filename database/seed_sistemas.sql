...
-- =====================================================
INSERT INTO subjects (code, name, week_hours, duration) VALUES
  ('SyPdN', 'Sistemas y Procesos de Negocio', 3, 'anual'),
  ('F1', 'Física I', 5, 'anual'),
  ('AM1', 'Análisis Matemático I', 5, 'anual'),
  ('AGA', 'Álgebra y Geometría Analítica', 5, 'anual'),
  ('AyED', 'Algoritmos y Estructura de Datos', 5, 'anual'),
  ('AdC', 'Arquitectura de Computadores', 4, 'anual'),
  ('InglesI', 'Inglés Técnico Nivel I', 2, 'anual'),
  ('LyED', 'Lógica y Estructuras Discretas', 3, 'anual'),
  ('ASI', 'Análisis de Sistemas de Información', 6, 'anual'),
  ('AM2', 'Análisis Matemático II', 5, 'anual'),
  ('F2', 'Física II', 5, 'anual'),
  ('IyS', 'Ingeniería y Sociedad', 4, 'cuatrimestral'),
  ('SySL', 'Sintaxis y Semántica de los Lenguajes', 4, 'anual'),
  ('PdP', 'Paradigmas de Programación', 4, 'anual'),
  ('SSOO', 'Sistemas Operativos', 8, 'cuatrimestral'),
  ('InglesII', 'Inglés Técnico Nivel II', 2, 'anual'),
  ('DSI', 'Diseño de Sistemas de Información', 6, 'anual'),
  ('PyE', 'Probabilidad y Estadística', 6, 'cuatrimestral'),
  ('BD', 'Bases de Datos', 6, 'cuatrimestral'),
  ('DdS', 'Desarrollo de Software', 6, 'cuatrimestral'),
  ('CD', 'Comunicación de Datos', 6, 'cuatrimestral'),
  ('AN', 'Análisis Numérico', 6, 'cuatrimestral'),
  ('AdmSI', 'Administración de Sistemas de Información', 6, 'anual'),
  ('IyCS', 'Ingeniería y Calidad de Software', 6, 'cuatrimestral'),
  ('RD', 'Redes de Datos', 6, 'cuatrimestral'),
  ('IO', 'Investigación Operativa', 6, 'cuatrimestral'),
  ('Sim', 'Simulación', 6, 'cuatrimestral'),
  ('TpA', 'Tecnologías para la Automatización', 6, 'cuatrimestral'),
  ('IA', 'Inteligencia Artificial', 6, 'cuatrimestral'),
  ('CdC', 'Ciencia de Datos', 6, 'cuatrimestral'),
  ('SG', 'Sistemas de Gestión', 6, 'cuatrimestral'),
  ('GC', 'Gestión Gerencial', 6, 'anual'),
  ('SSI', 'Seguridad en los Sistemas de Información', 6, 'cuatrimestral'),
  ('082122', 'Administración Estratégica del Capital Humano', 3, 'cuatrimestral'),
  ('232062', 'Ciberseguridad', 3, 'cuatrimestral'),
  ('232063', 'Experiencia de Usuario y Accesibilidad', 6, 'cuatrimestral'),
  ('232064', 'Gestión del Talento Humano', 6, 'cuatrimestral'),
  ('232065', 'Ingeniería de Requisitos', 6, 'cuatrimestral'),
  ('232066', 'Metodología de la Conducción de Equipos de Trabajo', 6, 'cuatrimestral'),
  ('232067', 'Técnicas Avanzadas de Programación', 6, 'cuatrimestral'),
  ('232068', 'Técnicas de Gráficos por Computadora', 6, 'cuatrimestral'),
  ('232069', 'Tendencias y Escenarios Tecnológicos', 6, 'cuatrimestral'),
  ('232070', 'Transformación Digital', 6, 'cuatrimestral'),
  ('082071', 'Criptografía', 6, 'cuatrimestral'),
  ('082073', 'Tecnologías Avanzadas en la Construcción de Software', 6, 'cuatrimestral'),
  ('232071', 'Comunicación Gráfica y Visual', 6, 'cuatrimestral'),
  ('232072', 'Metodología de la Investigación Científico-Tecnológica', 6, 'cuatrimestral'),
  ('232061', 'Química Ambiental', 6, 'cuatrimestral'),
  ('SEMINT', 'Seminario Integrador', 0, 'cuatrimestral')
AS new_subject
ON DUPLICATE KEY UPDATE
